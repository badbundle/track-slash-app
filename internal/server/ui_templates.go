...
var uiTemplates = template.Must(template.New("ui").Funcs(template.FuncMap{
	...
	"githubTokenCreateModal":         uiGitHubTokenCreateModal,
	"githubTokenEditModal":           uiGitHubTokenEditModal,
	"githubTokenFormValue":           uiGitHubTokenFormValue,
	"githubTokenError":               uiGitHubTokenFormError,
	"githubTokenPath":                uiSettingsGitHubTokenPath,
	"githubTokenDelete":              uiSettingsGitHubTokenDeletePath,
	"byteSize":                       uiByteSize,
