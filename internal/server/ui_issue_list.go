	...
	tabs := uiTabBarData{
		...
		Items: []uiTabItem{
			...
			},
			{
				Label:          "Whiteboard",
				Icon:           "presentation",
				Href:           uiProjectViewPath(project, "whiteboard"),
				HXGet:          uiProjectPanelPath(project, "whiteboard"),
				HXTarget:       projectPanelTarget,
				HXPushURL:      uiProjectViewPath(project, "whiteboard"),
				HXSelect:       projectPanelTarget,
				HXSelectOOB:    projectPanelSelectOOB,
				HXSwap:         "outerHTML",
				Active:         view == "whiteboard",
				MobileOverflow: true,
			},
			{
				Label:          "About",
